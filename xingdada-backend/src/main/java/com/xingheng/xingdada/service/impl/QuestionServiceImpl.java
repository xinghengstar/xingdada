...
import com.xingheng.xingdada.mapper.QuestionMapper;
import com.xingheng.xingdada.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appId == null || appId <= 0, ErrorCode.PARAMS_ERROR, "非法");
        }
        // 修改数据时，有参数则校验
        if (appId != null) {
